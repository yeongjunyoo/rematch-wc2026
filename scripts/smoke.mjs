...
const ROUTES = [
  { hash: "#/", must: ["REMATCH", "손흥민이 벤치에 있던", "전술로 결과를 다시 쓰는 게임", "대한민국 벤치 이어받기", "아르헨티나 벤치 이어받기", "경기 기록 보기"] },
  { hash: "#/match/za-kor-2026", must: ["매치룸", "전술 바꾸기", "개입 토큰", "실제로는", "대한민국", "남아공"], shot: true },
