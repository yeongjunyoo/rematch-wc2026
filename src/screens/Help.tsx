...
export function Help() {
  ...
  return (
    <main className="page narrow-page">
      ...
      <section className="help-section">
        <h2>의도적으로 넣은 보정</h2>
        <p>실축 통계에서 유도한 값이 아니라 게임을 위해 저자가 정한 보정이 두 가지 있습니다. 감추지 않고 밝힙니다.</p>
        <p>첫째, 당신 팀에 기회가 오래 없으면 다음 기회의 문턱이 조금씩 올라갑니다. 상한이 있어 기회가 확정되지는 않고 상대에게는 걸리지 않습니다. 사건이 하나도 없으면 당신의 결정이 개입할 대상 자체가 사라지기 때문입니다.</p>
        <p>둘째, 출처로 이름이 확인된 선수는 재구성 선수보다 낫고, 각 경기의 상징 선수는 그보다 더 낫습니다. 그가 마무리하는 장면의 성공률도 높습니다. 그를 넣는 선택이 아무것도 바꾸지 않으면 이 게임의 전제가 무너지기 때문입니다.</p>
        <p>두 보정 모두 시드와 당신의 행동만으로 결정되므로 같은 매치 코드는 여전히 같은 경기를 재현합니다.</p>
      </section>
